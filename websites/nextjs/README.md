...
Next.js template projects live here, one folder per category:

```
websites/nextjs/<category>/<template-name>/
```
...
1. Drop a complete Next.js project folder (e.g. from `npx create-next-app@latest`)
