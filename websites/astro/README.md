...
Astro template projects live here, one folder per category:

```
websites/astro/<category>/<template-name>/
```
...
1. Drop a complete Astro project folder (e.g. from `npm create astro@latest`)
